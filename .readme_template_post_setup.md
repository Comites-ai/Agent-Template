...
AGPL-3.0. See [LICENSE.txt](LICENSE.txt) and [TRADEMARK.md](TRADEMARK.md).

## Acknowledgements

Bootstrapped from the [Comites.ai Agent Template](https://github.com/Comites-ai/agent-template). The Forum and the agent template are open source under AGPL-3.0.
